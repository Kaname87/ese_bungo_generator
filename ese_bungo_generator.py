...
def replace_noun_by_similar_word(target_text, noun_list, tagger, used_word):
    ...
    for parsed_word in sorted_text_list:
        ...
        if is_noun(part):
            ...
            # プレースホルダーで置き換え
            placeholder = generate_unique_place_holder(placeholder_similar_word_dict)
        ...
        for novel in novel_list:
            ...
            for q_idx in range(len(novel['quotes'])):
                ...
                for _ in range(num):
                    ...
                    generated_quote = replace_noun_by_similar_word(quote, noun_list_dict, tagger, used_word)
                    ...
                    generated_title = replace_noun_by_similar_word(title, noun_list_dict, tagger, used_word)
                    generated_name = ''
                    ...
                    print('---')
                    fake = [generated_name, generated_title, generated_quote, orginal_list_idx]
                    results.append(fake)
